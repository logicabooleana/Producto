...
class DynamicThemeState extends State<DynamicTheme> {
  ...
  String _infoThemeOscuro =
      "Un tema oscuro es una IU con poca luz que muestra principalmente superficies oscuras.";
  String _infoThemeLuz =
      "Un tema claro es una IU con mucha luz que muestra principalmente superficies blanca o clara.";
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          ElasticIn(
            manualTrigger: false,
            /*  (opcional) si es verdadero, no activará la animación al cargar */
            controller: (controller) =>
                animateController_icon_title = controller,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                SizedBox(width: 12.0),
                Text(
                  (brightness == Brightness.dark) ? "Tema oscuro" : "Tema luz",
          ...
          SwitchListTile(
              ...
              secondary: FadeInLeft(
                controller: (controller) =>
                    animateController_icon_isDark = controller,
  ...
  /* [ START - Vista ListTile seleccion de tema ] */
  /* Vista : Muesta un Icono,Titulo,Descripción y un SwitchListTile */
  /* Acción : Cambia el brillo del tema a oscuro o luz */
  ...
  Widget getIConButton(BuildContext context) {
    return IconButton(
        icon: brightness == Brightness.dark
            ? const Icon(Icons.brightness_3, size: 24.0)
            : const Icon(Icons.brightness_7, size: 24.0),
        onPressed: () {
